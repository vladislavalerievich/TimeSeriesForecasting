...
#SBATCH --output outputs/logs/generate_forecastpfn_dataset_%x-%A.out   # STDOUT  %x and %A will be replaced by the job name and job id, respectively. short: -o logs/%x-%A-job_name.out
...
python scripts/continuous_generation.py --generator forecastpfn --max-series 1000000 --batch-size 1024
